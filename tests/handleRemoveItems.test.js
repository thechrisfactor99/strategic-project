...
test('removes correct items from list', () => {
  const removedList = handleRemoveItems(testList, removeList1)
  expect(removedList.length).toBe(8);
  expect(removedList[0]['id']).toBe(3)
});